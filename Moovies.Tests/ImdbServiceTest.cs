...
namespace Moovies.Tests
{
    ...
    public class ImdbServiceTest
    {
        ...
        {
            _csv = "\"position\",\"const\",\"created\",\"modified\",\"description\",\"Title\",\"Title type\",\"Directors\",\"You rated\",\"IMDb Rating\",\"Runtime (mins)\",\"Year\",\"Genres\",\"Num. Votes\",\"Release Date (month/day/year)\",\"URL\"\r\n\"1\",\"tt1255953\",\"Sat Jan 28 00:00:00 2017\",\"\",\"\",\"Incêndios\",\"Feature Film\",\"Denis Villeneuve\",\"10\",\"8.2\",\"131\",\"2010\",\"drama, mystery, war\",\"88199\",\"2010-09-03\",\"http://www.imdb.com/title/tt1255953/\"\r\n\"2\",\"tt4698684\",\"Sat Jan 21 00:00:00 2017\",\"\",\"\",\"A Incrível Aventura de Rick Baker\",\"Feature Film\",\"Taika Waititi\",\"9\",\"7.9\",\"101\",\"2016\",\"adventure, comedy, drama\",\"40156\",\"2016-01-22\",\"http://www.imdb.com/title/tt4698684/\"";
        ...
        [TestMethod]
        public void Read_Runtime_Genres()
        {
            var imdbMoviesCollection = _imdbService.GetRecords(_csv);
            Assert.AreEqual(new string[] { "drama", "mystery", "war" }[0], imdbMoviesCollection[0].Genres[0]);
            Assert.AreEqual(new string[] { "drama", "mystery", "war" }[1], imdbMoviesCollection[0].Genres[1]);
            Assert.AreEqual(new string[] { "drama", "mystery", "war" }[2], imdbMoviesCollection[0].Genres[2]);
        }
        ...
        public void Calculate_Total_Time()
        {
            ...
            Assert.AreEqual(232, imdbData.TotalTime);
        }
    }
}
